  ...
  global.async.eachOf(thisPlugin.modelFiles, function(value, key, callback) {
    try {
      ...
      $.getScript(pluginDir+value, function(data, textStatus, jqxhr) {
        ...
        var constructor = "new "+thisPlugin.modelNames[key]+"(null,{pluginData: pluginData, pluginHandle: thisPlugin })";
  ...
  global.async.eachOf(thisPlugin.collectionFiles, function(value, key, callback) {
    try {
      ...
      $.getScript(pluginDir+value, function(data, textStatus, jqxhr) {
        ...
        var constructor = "new "+thisPlugin.collectionNames[key]+"(undefined, {pluginData: pluginData, pluginHandle: thisPlugin })";
